...
func TestUpdateAccount(t *testing.T) {
	...
	accountUpdated, err := testQueries.GetAccount(context.Background(), account1.ID)
	...
	require.WithinDuration(t, account1.CreatedAt, accountUpdated.CreatedAt, time.Second)
